    ...
    <nav class="navbar navbar-expand-md bg-dark sticky-top border-bottom" data-bs-theme="dark">
        <div class="container">
            <div class="dropdown mt-3">
                <button class="btn btn-secondary dropdown-toggle navbar-toggler" type="button" data-bs-toggle="dropdown" data-bs-target="#offcanvas"
    ...
    <main>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
            <div class="col-md-6 p-lg-5 mx-auto my-5">
                ...
                <h3 class="fw-normal text-muted mb-3">For all your student activities</h3>
                <div class="d-flex gap-3 justify-content-center lead fw-normal">
                    <a class="icon-link" href="./download">
                        Download
                        <svg class="bi"><use xlink:href="#chevron-right"/></svg>
                    </a>
                    <a class="icon-link" href="./rent">
                        Rent
                        <svg class="bi"><use xlink:href="#chevron-right"/></svg>
                    </a>
                </div>
        ...
        <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
            <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                <div class="my-3 p-3">
                    ...
                    <p><a class="btn btn-secondary" href="./download">View details &raquo;</a></p>
                </div>
                <div class="bg-body shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;
      background-image: url('{{ \Illuminate\Support\Facades\Vite::asset('resources/images/beerimage1.jpg') }}'); background-size: cover;"></div>
            </div>
            <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                <div class="my-3 py-3">
                    <h2 class="display-5">Rent our Brew Bot</h2>
                    <p class="lead">Rent the Brew Bot for your student events.</p>
                    <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
                </div>
                <div class="bg-body shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;
                    background-image: url('{{ \Illuminate\Support\Facades\Vite::asset('resources/images/beerimage2.jpg') }}'); background-size: cover;"></div>
            </div>
        </div>
        ...
        <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
            <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                <div class="my-3 p-3">
                    <h2 class="display-5">More Information</h2>
                    <p class="lead">Find more information about the Brew Bot.</p>
                    <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
                </div>
                <div class="bg-body shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;
      background-image: url('{{ \Illuminate\Support\Facades\Vite::asset('resources/images/beerimage3.jpg') }}'); background-size: cover;"></div>
            </div>
            <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                <div class="my-3 py-3">
                    <h2 class="display-5">Support</h2>
                    <p class="lead">Contact us using our Contact Form.</p>
                    <p><a class="btn btn-secondary" href="#">View details &raquo;</a></p>
                </div>
                <div class="bg-body shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;
      background-image: url('{{ \Illuminate\Support\Facades\Vite::asset('resources/images/beerimage4.jpg') }}'); background-size: cover;"></div>
            </div>
        </div>
    </main>
